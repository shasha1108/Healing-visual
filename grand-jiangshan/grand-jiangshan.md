...
> **Tech Keywords:** Three.js WebGL, custom GLSL shader, 4D Simplex noise terrain, 470K particle system, OrbitControls

<!-- WORK_META
  slug: grand-jiangshan
  render_engine: Three.js WebGL r128
  particle_count: 470K (450K mountains + 20K snow)
  ...
  audio: N/A
  effects: N/A
  use_cases: three.js webgl interactive H5, webgl particle system demo, glsl shader art, digital healing visualization
  standalone: yes
